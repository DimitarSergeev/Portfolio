    ...
    return (
        ...
        <section className={styles.section}>
            ...
            <div className={styles.additional}>
                <h2 className={styles['additional-title']}>Additional Contacts</h2>
                <div className={styles['contacts-icons']}>
                    <div className={styles.phone}>
                        <i className="fa-brands fa-viber"> Viber</i>
                        <i className="fa-brands fa-telegram"> Telegram</i>
                        <span>+359 88 261 3775</span>
                    </div>
                    <div className={styles.mail}>
                        <i className="fa-solid fa-square-envelope"> Email</i>
                        <span>sergeev88@abv.bg</span>
                    </div>
                </div>
            </div>
